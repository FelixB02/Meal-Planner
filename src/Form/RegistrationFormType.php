...
class RegistrationFormType extends AbstractType
{
    ...
    {
        $builder
            ->add('email', null, array("attr" => ["class" => "form-control w-100", "placeholder" => "Write a Email"], "label" => "Email: "))
            ...
            //     // this is read and encoded in the controller
            //     'mapped' => false,
            //     'attr' => ['autocomplete' => 'new-password', "class" => "form-control w-100", "placeholder" => "Repeat Password"],
            //     'constraints' => [
            //         new NotBlank([
            //             'message' => 'Please enter a password',
            //         ]),
            ...
            ->add('password', RepeatedType::class, [
                ...
                'options' => ['attr' => ['class' => 'password-field form-control', 'placeholder' => 'Password']],
                'required' => true,
